...
@triton.jit
def triton_sqrt_rn(in_ptr0, out_ptr0, xnumel, XBLOCK: tl.constexpr, XBLOCK_SUB: tl.constexpr):
...
def test_sqrt_rn():
    ...
    torch_res = torch_sqrt_rn(x0)
    triton_res = torch.empty_like(x0)
    triton_sqrt_rn[ncore, 1, 1](x0, triton_res, x0.numel(), xblock, xblock_sub)
