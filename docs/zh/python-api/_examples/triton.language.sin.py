...
@triton.jit
def triton_sin(in_ptr0, out_ptr0, xnumel, XBLOCK: tl.constexpr, XBLOCK_SUB: tl.constexpr):
...
def test_sin():
    ...
    torch_res = torch_sin(x0)
    triton_res = torch.empty_like(x0)
    triton_sin[ncore, 1, 1](x0, triton_res, x0.numel(), xblock, xblock_sub)
